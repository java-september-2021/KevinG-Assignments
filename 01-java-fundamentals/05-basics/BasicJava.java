...
public class BasicJava {
    ...
    /*
     * Sigma of 255 AKA Sum to 255 Write a method that creates and eventually
     * returns a sum variable that adds up all the numbers from 1 to 255. In this
     * method you are not printing the sum, except to debug if you need to, the
     * method should return the sum. Note: You do not need an array to write this
     * function.
     */
    ...
    // write a method that would iterate
    ...
    public static ArrayList<Integer> arrOdd() {
