package com.kevingardner.dojosurvey.controllers;
...
import com.kevingardner.dojosurvey.models.SurveyModel;
...
public class SurveyController {
	...
	public String Results(@RequestParam(value="name") String name, 
			...
			Model model){
		model.addAttribute("result", new SurveyModel(name, location, language, comment));
		return "result.jsp";
	}
